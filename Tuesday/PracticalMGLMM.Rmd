...
Before the bonus task, check out extra dias on how these models connect with diversity measures:
5. Bonus task: Try to build an ecological understanding of variance parameters in terms of diversity (gamma and beta) and turnover
