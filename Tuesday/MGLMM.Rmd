...
knitr::include_graphics("C:/Users/jemaelni/OneDrive - Jyväskylän yliopisto/TestsForgllvm/gllvmCourse/packages.png")
```
...
knitr::include_graphics("C:/Users/jemaelni/OneDrive - Jyväskylän yliopisto/TestsForgllvm/gllvmCourse/SamplingDesign.png")
```
...
# Example 2: code for a model fit
...
load(file = "C:/Users/jemaelni/OneDrive - Jyväskylän yliopisto/TestsForgllvm/gllvmCourse/modelX.RData")
```
...
vp<- VP(modelX)
vp$PropExplainedVarSp<-vp$PropExplainedVarSp[1:100,]
vp$LVpartit<-vp$LVpartit[1:100,]
plot(vp, col=hcl.colors(7, "Roma"))
```
...
knitr::include_graphics("C:/Users/jemaelni/OneDrive - Jyväskylän yliopisto/TestsForgllvm/gllvmCourse/VPplot.png")
```
